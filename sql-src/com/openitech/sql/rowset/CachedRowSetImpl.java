/*
 * @(#)CachedRowSetImpl.java	1.30 10/03/23
 * 
...
public class CachedRowSetImpl extends BaseRowSet implements RowSet, RowSetInternal, Serializable, Cloneable, CachedRowSet {
   ...
   */
  private String DEFAULT_SYNC_PROVIDER = "com.openitech.sql.rowset.providers.RIOptimisticProvider";
  /**
  ...
  {
    SyncFactory.registerProvider("com.openitech.sql.rowset.providers.RIOptimisticProvider");
  }
   ...
   * optimistic provider <code>com.openitech.sql.rowset.providers.RIOptimisticProvider</code>.
   * <p>
   ...
   * @param data the <code>ResultSet</code> object containing the data
   *             to be read into this <code>CachedRowSetImpl</code> object
   * @param includeRows specifies the rows in the
   ...
   * @see #execute
   */
  public void populate(ResultSet data, java.util.Set<Integer> includeRows) throws SQLException {
    int rowsFetched;
    Row currentRow;
    int numCols;
    int i;
    ...
    if (includeRows==null) {
      includeRows = new HashSet<Integer>();
    }

    data.beforeFirst();

    while (data.next()) {
      if (includeRows.contains(++pos)) {
