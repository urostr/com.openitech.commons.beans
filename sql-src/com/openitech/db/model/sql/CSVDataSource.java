 ...
 * @author uros
 */
public class CSVDataSource extends AbstractDataSourceImpl {
  ...
  private final LogWriter logWriter = new LogWriter(Logger.getLogger(CSVDataSource.class.getName()), Level.INFO);
  /**
...
//      this.cachedStatements.putAll(sqlDataSource.cachedStatements);
  ...
  private final static class RunnableEvents implements Runnable {
    ...
    RunnableEvents(CSVDataSource owner) {
      this.owner = owner;
    }
