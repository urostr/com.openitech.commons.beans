...
public class JDbPasswordFieldBeanInfo extends SimpleBeanInfo {
    ...
    private static final int METHOD_changedUpdate0 = 0;
    ...
    private static final int METHOD_insertUpdate3 = 3;
    private static final int METHOD_removeUpdate4 = 4;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_changedUpdate0] = new MethodDescriptor(com.openitech.db.components.JDbPasswordField.class.getMethod("changedUpdate", new Class[] {javax.swing.event.DocumentEvent.class})); // NOI18N
            methods[METHOD_changedUpdate0].setDisplayName ( "" );
            methods[METHOD_dataSource_fieldValueChanged1] = new MethodDescriptor(com.openitech.db.components.JDbPasswordField.class.getMethod("dataSource_fieldValueChanged", new Class[] {com.openitech.db.events.ActiveRowChangeEvent.class})); // NOI18N
            methods[METHOD_dataSource_fieldValueChanged1].setDisplayName ( "" );
            methods[METHOD_dataSource_toolTipFieldValueChanged2] = new MethodDescriptor(com.openitech.db.components.JDbPasswordField.class.getMethod("dataSource_toolTipFieldValueChanged", new Class[] {com.openitech.db.events.ActiveRowChangeEvent.class})); // NOI18N
            methods[METHOD_dataSource_toolTipFieldValueChanged2].setDisplayName ( "" );
            methods[METHOD_insertUpdate3] = new MethodDescriptor(com.openitech.db.components.JDbPasswordField.class.getMethod("insertUpdate", new Class[] {javax.swing.event.DocumentEvent.class})); // NOI18N
            methods[METHOD_insertUpdate3].setDisplayName ( "" );
            methods[METHOD_removeUpdate4] = new MethodDescriptor(com.openitech.db.components.JDbPasswordField.class.getMethod("removeUpdate", new Class[] {javax.swing.event.DocumentEvent.class})); // NOI18N
            methods[METHOD_removeUpdate4].setDisplayName ( "" );
        }
