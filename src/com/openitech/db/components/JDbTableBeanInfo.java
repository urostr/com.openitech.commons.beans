...
public class JDbTableBeanInfo extends SimpleBeanInfo {
    ...
    private static final int METHOD_tableModel_activeRowChanged0 = 0;
    private static final int METHOD_valueChanged1 = 1;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            methods[METHOD_tableModel_activeRowChanged0] = new MethodDescriptor(com.openitech.db.components.JDbTable.class.getMethod("tableModel_activeRowChanged", new Class[] {com.openitech.db.events.ActiveRowChangeEvent.class})); // NOI18N
            methods[METHOD_tableModel_activeRowChanged0].setDisplayName ( "" );
            methods[METHOD_valueChanged1] = new MethodDescriptor(com.openitech.db.components.JDbTable.class.getMethod("valueChanged", new Class[] {javax.swing.event.ListSelectionEvent.class})); // NOI18N
            methods[METHOD_valueChanged1].setDisplayName ( "" );
        }
