 ...
 *
 */
public final class DbWSSyncProvider extends SyncProvider implements Serializable {

  private DbSecondarySpringRowSetReader reader;
  private DbRowSetWriter writer;
  public static String PROVIDER = DbWSSyncProvider.class.getName();
  /**
