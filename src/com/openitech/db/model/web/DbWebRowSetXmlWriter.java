/*
 * @(#)WebRowSetXmlWriter.java	1.12 10/03/23
 *
 ...
 */
public class DbWebRowSetXmlWriter implements XmlWriter, Serializable {
...
//          String clob = caller.getString(idx);
//          String result = null;
////          if (clob != null && clob.length() > 0) {
////            result = ((java.sql.Clob) clob).getSubString(1L, (int) ((java.sql.Clob) clob).length());
////          }
