...
public class RazdeliTelefonskoStevilko {
  ...
  public static String[] razbij(String telefonskaStevilka) {
    String[] result = null;
    if (telefonskaStevilka != null) {
      if (!telefonskaStevilka.startsWith("0")) {
        telefonskaStevilka = "0" + telefonskaStevilka;
      }
//----------
...
//---------
      ...
      if ((result == null) && (telefonskaStevilka != null)) {
        String[] telefon = new String[2];

        int pos = 0;
        for (int i = 0; i < telefonskaStevilka.length(); i++) {
          if (Character.isDigit(telefonskaStevilka.charAt(i))) {
            if (telefon[pos] == null) {
              telefon[pos] = "";
            }
            telefon[pos] = telefon[pos] + telefonskaStevilka.charAt(i);
          } else if (pos == 0) {
            pos++;
          }
        }
