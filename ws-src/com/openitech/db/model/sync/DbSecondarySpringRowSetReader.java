 ...
 */
public class DbSecondarySpringRowSetReader implements RowSetReader, Serializable {
    ...
    public void readData(RowSetInternal caller) throws SQLException {
        ...
        try {
            ...
            for (Map.Entry entry : eq.getNamedParameters().entrySet()) {
                ...
                parameter.setFieldValueIndex(field.getFieldIndex());
                parameter.setValue(((SqlParameter) entry.getValue()).getValue());
