 ...
 *
 */
public final class DbEventSpringSyncProvider extends SyncProvider implements Serializable {

  private DbEventSpringRowSetReader reader;
  private DbRowSetWriter writer;
  public static String PROVIDER = DbEventSpringSyncProvider.class.getName();
  /**
   ...
   */
  public DbEventSpringSyncProvider() {
    providerID = this.getClass().getName();
    reader = new DbEventSpringRowSetReader();
