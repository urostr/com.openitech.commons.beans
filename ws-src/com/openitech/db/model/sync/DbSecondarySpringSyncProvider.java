 ...
 *
 */
public final class DbSecondarySpringSyncProvider extends SyncProvider implements Serializable {

  private DbSecondarySpringRowSetReader reader;
  private DbRowSetWriter writer;
  public static String PROVIDER = DbSecondarySpringSyncProvider.class.getName();
  /**
   ...
   */
  public DbSecondarySpringSyncProvider() {
    providerID = this.getClass().getName();
    reader = new DbSecondarySpringRowSetReader();
