...
//        provider =
//        (SyncProvider)SyncFactory.getInstance(DbEventSyncProvider.PROVIDER);
//
...
//      crsReader.setStartPosition(1);
    ...
    /**
     * Sets the active <code>SyncProvider</code> and
     * and sets rowSetreader and rowSetWriter
     *
     * @param SycnProvider provider provider with implemented
     *       rowSetReader and rowSetWriter
     *
     * @throws SQLException if an error occurs while resetting the
     * 		<code>SyncProvider</code>.
     */
    public void setSyncProvider(SyncProvider provider) throws SQLException {
...
//    }
    ...
    public void updateClob(int columnIndex, Clob c) throws SQLException {
        ...
        // or through RowSetMetaData.locatorsUpdatorCopy()
            ...
            getCurrentRow().setColumnObject(columnIndex, c);
